...
import PetSpicie from "../screens/Start/PetSpice/PetSpicie";
...
const StartingScreensNavigations = ({ navigation }) => {
  ...
  const initialScreen = currentPetId || myPets.length > 0 ? "Welcome" : "PetSpicie";
  ...
  return (
    <StartingStack.Navigator key={initialScreen} initialRouteName={initialScreen}>
