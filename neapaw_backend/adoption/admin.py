...
class AdoptionApplicationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('KYC Documents', {
            'fields': ('kyc_document_link', 'user_photo_link', 'police_report_link')
        }),
    ...
    def kyc_document_link(self, obj):
        return self._file_link(obj.kyc_document, "View KYC document")
    kyc_document_link.short_description = "KYC document"

    def user_photo_link(self, obj):
        return self._file_link(obj.user_photo, "View user photo")
    user_photo_link.short_description = "User photo"
