...
class TreatmentTypeAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'base_price', 'duration_minutes', 'icon_image')
    search_fields = ('name', 'description')
    
    fieldsets = ( #section of forms
        ('Basic Information', {
            'fields': ('name', 'description', 'icon_image')
        }),
        ('Pricing & Duration', {
...
class TreatmentBookingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Status & Pricing', {
            'fields': ('status', 'price', 'payment_method_display')
        }),
        ('Timestamps', {
    ...
    def booking_id(self, obj):
        ...
        return str(obj.order.order_number).replace('ORD-', 'TREATMENT-')
