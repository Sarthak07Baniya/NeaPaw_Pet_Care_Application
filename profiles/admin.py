...
class ShippingAddressAdmin(admin.ModelAdmin):
    ...
    set_as_default.short_description = "Set selected address as default"


@admin.register(SavedCard)
class SavedCardAdmin(admin.ModelAdmin):
    """Admin configuration for SavedCard Model"""
    list_display = ('user', 'card_type', 'last_four_digits', 'cardholder_name', 'get_expiry_date', 'is_default')
    ...
    def get_expiry(self, obj):
        """Display expiry date"""
        return f"{obj.expiry_month:02}/{obj.expiry_year}"
    ...
    set_as_default.short_description = "Set selected card as default"
